<header class="main-header">
   <a href="index.html" class="logo">
      ...
      <span class="logo-mini">
         <img src="{{ asset('admin/dist/img/mini-logo.png') }}" alt="">
      </span>
      <span class="logo-lg">
                  ...
                  <ul class="menu">
                     <li >
                        ...
                        <a href="#" class="border-gray">
                           <div class="pull-left">
                              <img src="{{ asset('admin/dist/img/basketball-jersey.png') }}" class="img-thumbnail" alt="User Image">
                           </div>
                           <h4>polo shirt</h4>
   ...
   <li class="dropdown dropdown-help hidden-xs">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
         ...
         <li class="dropdown dropdown-user">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
               <img src="{{ asset('admin/dist/img/avatar5.png') }}" class="img-circle" width="45" height="45" alt="user"></a>
               <ul class="dropdown-menu" >
                  <li>
                     <a href="profile.html">
