...
<!-- /.wrapper -->
<script src="{{asset('admin/plugins/jQuery/jquery-1.12.4.min.js')}}" type="text/javascript"></script>
<!-- jquery-ui -->
<script src="{{asset('admin/plugins/jquery-ui-1.12.1/jquery-ui.min.js')}}" type="text/javascript"></script>
<!-- Bootstrap -->
<script src="{{asset('admin/bootstrap/js/bootstrap.min.j')}}s" type="text/javascript"></script>
<!-- lobipanel -->
<script src="{{asset('admin/plugins/lobipanel/lobipanel.min.js')}}" type="text/javascript"></script>
<!-- Pace js -->
<script src="{{asset('admin/plugins/pace/pace.min.j')}}s" type="text/javascript"></script>
<!-- SlimScroll -->
...
<!-- Monthly js -->
<script src="{{asset('admin/plugins/monthly/monthly.j')}}s" type="text/javascript"></script>
...
<script type="text/javascript" charset="utf8" src="{{asset('admin/dist/js/jquery.dataTables.min.js')}}"></script>
